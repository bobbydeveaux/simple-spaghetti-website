...
from api.data_store import BOOKS, AUTHORS, MEMBERS, BALLOTS, VOTES
...
def validate_vote(data: Dict[str, Any], member_id: int) -> Tuple[bool, Optional[str]]:
    """
    Validate vote data for submission.
    ...
    existing_votes = [vote for vote in VOTES.values()
                     if vote["ballot_id"] == ballot_id and vote["member_id"] == member_id]
